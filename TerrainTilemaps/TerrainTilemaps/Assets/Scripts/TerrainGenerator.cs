...
public class TerrainGenerator : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        tilemap.transform.position = new Vector3(-(terrainWidth / 2), -(terrainHeight / 2), 0);
        GenerateTerrain();
    ...
    {
        float seed = Random.Range(.1f, 2f);
        mapArray = GenerateArray(terrainWidth, terrainHeight, true);
        StartCoroutine(RenderMap(PerlinNoiseSmooth(mapArray, seed, 2), tilemap, tile));
    }
